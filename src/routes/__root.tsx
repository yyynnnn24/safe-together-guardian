...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SafeTogether — Female Friendly Safety App" },
      {
        name: "description",
        content:
          "SafeTogether is a female-friendly safety companion with SOS alerts, live location sharing, trusted contacts, safety check-ins, and incident reporting.",
      },
      { name: "author", content: "SafeTogether" },
      { property: "og:title", content: "SafeTogether — Female Friendly Safety App" },
      {
        property: "og:description",
        content: "One-tap SOS, live location, safety check-ins, and community incident map.",
      },
